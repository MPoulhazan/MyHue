        ...
        dataLocations: [
            {
                location: DATA_LOCATIONS.SERVER_LOCAL,
                details: [
                    'Chat conversation history (in memory)',
                    'Current light states',
                    'Sensor data',
                    'Scene/room information',
                ],
            },
            {
                location: DATA_LOCATIONS.LOCAL_STORAGE,
                details: ['Chat message history (browser cache)'],
            },
        ],
        authentication: {
            required: false,
            type: 'No authentication (local agent)',
        },
        dataTypes: ['Chat History', 'System Context', 'Home State'],
        privacyScore: 85,
        risks: [
            'Chat history in browser storage may contain home automation commands',
            'Server has access to all home device states while responding',
        ],
        positives: [
            '✅ Uses Ollama (local LLM - not cloud)',
